...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void insertPosition(Position position) {
        ...
        Log.v(TAG, "[Guru]insertPosition:" + position.getDeviceId());

        ContentValues values = new ContentValues();

        //values.put("deviceId", position.getDeviceId());
        values.put("deviceId", C.TraccarConnParam.TRACCAR_CONN_DEVICEID);
    ...
    public Position selectPosition() {
        ...
        try {
            if (cursor.getCount() > 0) {
                ...
                position.setDeviceId(C.TraccarConnParam.TRACCAR_CONN_DEVICEID);
                Log.v(TAG, "[Guru]selectPosition:" + C.TraccarConnParam.TRACCAR_CONN_DEVICEID + ":" + cursor.getString(cursor.getColumnIndex("deviceId")));
