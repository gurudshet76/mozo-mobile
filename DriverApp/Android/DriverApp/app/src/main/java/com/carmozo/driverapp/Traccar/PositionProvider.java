...
public abstract class PositionProvider {
    ...
    public PositionProvider(Context context, PositionListener listener) {
        ...
        deviceId = C.TraccarConnParam.TRACCAR_CONN_DEVICEID;
        period = C.TraccarConnParam.TRACCAR_CONN_INTERVAL;
        ...
        type = C.TraccarConnParam.TRACCAR_CONN_PROVIDER;
        //type = preferences.getString(MainActivity.KEY_PROVIDER, null);

        Log.v (TAG, "[Guru]:" + deviceId + ":"+ period + ":" + type);
    }
    ...
    protected void updateLocation(Location location) {
        if (location != null && location.getTime() != lastUpdateTime) {
            Log.v(TAG, "[Guru]: location new:" + deviceId);
